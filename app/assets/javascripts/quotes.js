$(document).on('turbolinks:load', function(){
    ...
    $("#quote-food-items").on('change', 'select', function(event) {
        ...
        var customer_id = $("#quote_customer_id").val();

        console.log("QUOTE CUSTOM: ", customer_id);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var price = "quote_quote_food_items_attributes_" + object_id + "_price";
    ...
    $("#quote-food-items").on('change', "input", function(event) {
        var target_id = event.target.id;
        var target_value = $("#"+target_id ).val();
        console.log("Value: ", target_value);
        console.log("ID: ",target_id)
        ...
        // calcul
        //var discount = $("#quote_quote_food_items_attributes_" + object_id + "_discount").val();
        var price = $("#quote_quote_food_items_attributes_" + object_id + "_price").val();
        var amount = "quote_quote_food_items_attributes_" + object_id + "_amount";
...
*/
    ...
    $("#quote-product-items").on('change', 'select', function(event) {
        ...
        console.log("FIELD: ", field );
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var price = "quote_quote_product_items_attributes_" + object_id + "_unit_price";
                    $("#"+price).val(_price);
                }
            });
    ...
    $("#quote-product-items").on('change', "input", function(event) {
        var target_id = event.target.id;
        var target_value = $("#"+target_id ).val();
        console.log("Value: ", target_value);
        console.log("ID: ",target_id)
        ...
        // calcul
        var price = $("#quote_quote_product_items_attributes_" + object_id + "_unit_price").val();
        var amount = "quote_quote_product_items_attributes_" + object_id + "_amount";
